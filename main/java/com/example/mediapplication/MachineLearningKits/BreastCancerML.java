package com.example.mediapplication.MachineLearningKits;
...
public class BreastCancerML {
    ...
    private FirebaseCustomLocalModel configureLocalModelSource() {
        ...
        FirebaseCustomLocalModel localModel = new FirebaseCustomLocalModel.Builder()
                .setAssetFilePath("Breast_Cancer.tflite")
                .build();
    ...
    private void addDownloadListener(
            com.google.firebase.ml.custom.FirebaseCustomRemoteModel remoteModel,
    ...
    private FirebaseModelInputOutputOptions createInputOutputOptions() throws FirebaseMLException {
        ...
        FirebaseModelInputOutputOptions inputOutputOptions =
                new FirebaseModelInputOutputOptions.Builder()
                        .setInputFormat(0, FirebaseModelDataType.FLOAT32, new int[]{1,5})
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<FirebaseModelOutputs>() {
                            ...
                            public void onSuccess(FirebaseModelOutputs result) {
                                ...
                                DR.child("BreastCancerResult").setValue(output[0][0]);
                                if(output[0][0] >= .5){
//                                    res = true;
                                    T.setText("You have a" + output[0][0]*100 + "% chance of having breast cancer.");
                                }
                                else{
                                    T.setText("You do not have breast Cancer.");
                                }
