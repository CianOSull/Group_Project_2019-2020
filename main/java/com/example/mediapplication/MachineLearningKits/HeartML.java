...
public class HeartML {
        ...
        private FirebaseCustomRemoteModel configureHostedModelSource() {
            ...
            FirebaseCustomRemoteModel remoteModel =
                    new FirebaseCustomRemoteModel.Builder("heart_predict_model").build();
            return remoteModel;
        }
        ...
        private FirebaseCustomLocalModel configureLocalModelSource() {
            ...
            FirebaseCustomLocalModel localModel = new FirebaseCustomLocalModel.Builder()
                    .setAssetFilePath("Heart_Predict.tflite")
                    .build();
...
//    }
        ...
        public void runInference(final TextView T, float[][] input, final FloatHolder floatHolder, final DatabaseReference DR) throws FirebaseMLException {
                    ...
                    .addOnSuccessListener(
                            new OnSuccessListener<FirebaseModelOutputs>() {
                                ...
                                public void onSuccess(FirebaseModelOutputs result) {
                                    ...
                                    if(output[0][0] >= .5){
//                                    res = true;
                                        T.setText("You have a" + output[0][0]*100 + "% cance of having a Heart Defect");
                                        DR.child("HeartValue").setValue(output[0][0]);
                                    }
                                    else{
                                        T.setText("You do not have a heart defect.");
                                    }
